...
function init() {
	WebViewJavascriptBridge.init(function(message, responseCallback) {
	    ...
	    console.log("ajson")
    	var line1 = turf.linestring(json.points)
    	console.log("aline1")
		var buffered = turf.buffer(line1, json.buffer, 'meters'); 
		console.log("abuffered")
	    responseCallback(buffered.features[0].geometry.coordinates.toString());
	});
}

if (window.WebViewJavascriptBridge) {
	console.log("aBefore init 1")
	init()
} else {
	console.log("aadding event listener")
	document.addEventListener(
	    'WebViewJavascriptBridgeReady'
	    , function() {
	    	console.log("aBefore init 2")
	        init()
	    },
	    false
	);
